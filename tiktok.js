...
export async function tiktokv1(url) {
...
export async function tiktokv2(url) {
  try {
...
export async function tiktokv3(url) {
  try {
    async function expandTikTokUrl(u) {
      if (!/https?:\/\/(vt|vm)\.tiktok\.com\//i.test(u)) return u;
      const r = await requestHandler({
...
export default { tiktokv1, tiktokv2, tiktokv3, tiktokDl };